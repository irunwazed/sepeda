                    ...
                    $data['level'] = 3;
										...
										$target[6] = @$exp[0]?(double)$exp[0]:0;
											...
											$data = [
												...
												'rpjmd_program_indikator_th1_target' => $target[1],
												'rpjmd_program_indikator_th1_pagu' => $row[7],
												'rpjmd_program_indikator_th2_target' => $target[2],
												'rpjmd_program_indikator_th2_pagu' => $row[9],
												'rpjmd_program_indikator_th3_target' => $target[3],
												'rpjmd_program_indikator_th3_pagu' => $row[11],
												'rpjmd_program_indikator_th4_target' => $target[4],
												'rpjmd_program_indikator_th4_pagu' => $row[13],
												'rpjmd_program_indikator_th5_target' => $target[5],
												'rpjmd_program_indikator_th5_pagu' => $row[15],
												'rpjmd_program_indikator_th6_target' => $target[6],
												'rpjmd_program_indikator_th6_pagu' => $row[17],
                    ...
                    $this->kegiatan_kode = (int)($kode[3].$kode[4]);
										...
										if($this->indikator != ''){
											...
											$data = [
												...
												'renstra_kegiatan_indikator_th1_target' => $target[1],
												'renstra_kegiatan_indikator_th1_pagu' => $row[7],
												'renstra_kegiatan_indikator_th2_target' => $target[2],
												'renstra_kegiatan_indikator_th2_pagu' => $row[9],
												'renstra_kegiatan_indikator_th3_target' => $target[3],
												'renstra_kegiatan_indikator_th3_pagu' => $row[11],
												'renstra_kegiatan_indikator_th4_target' => $target[4],
												'renstra_kegiatan_indikator_th4_pagu' => $row[13],
												'renstra_kegiatan_indikator_th5_target' => $target[5],
												'renstra_kegiatan_indikator_th5_pagu' => $row[15],
												'renstra_kegiatan_indikator_th6_target' => $target[6],
												'renstra_kegiatan_indikator_th6_pagu' => $row[17],
