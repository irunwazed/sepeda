											...
											<table class="my-datatable table table-striped table-bordered">
												<thead>
													<tr>
														...
														<th rowspan="2">Capaian (Tahun {{ session('rpjmd_tahun')+session('tahun')-1 }})</th>
				...
				<form action="" id="form-data">
					...
					<div class="row">
						<div class="form-group col-sm-12">
							...
							<fieldset class="form-group">
								<textarea name="rpjmd_tujuan_nama" class="form-control" cols="30" rows="5"
									readonly></textarea>
							</fieldset>
						</div>
						<div class="form-group col-sm-12">
							...
							<fieldset class="form-group">
								<textarea name="rpjmd_tujuan_indikator_nama" class="form-control" cols="30" rows="5"
									readonly></textarea>
							</fieldset>
						</div>
						<div class="form-group col-sm-9">
							...
							<fieldset class="form-group">
								<input type="text" name="rpjmd_tujuan_indikator_target" class="form-control" readonly>
							</fieldset>
						</div>
						...
						<div class="form-group col-sm-12">
							<label for="basicInput">Capaian Kinerja</label>
							<fieldset class="form-group">
...
$(document).ready(function() {
	...
	var table = $('.my-datatable').DataTable({
		...
		columns: [{
			...
			{
				data: 'rpjmd_tujuan_indikator_th' + tahun_ke + '_target',
			},
			{
				data: 'pagu',
				render: function(e) {
			...
			{
				data: 'rpjmd_tujuan_indikator_th' + tahun_ke + '_realisasi_target',
			},
			{
				data: 'realisasi_pagu',
				render: function(e) {
			...
			{
				data: 'rpjmd_tujuan_indikator_th' + tahun_ke + '_capaian_target',
			},
			{
				data: 'action',
				name: 'action'
