				...
				<form action="" id="form-data">
					...
					<div class="row">
						<div class="form-group col-sm-12">
							...
							<fieldset class="form-group">
								<textarea name="rpjmd_sasaran_nama" class="form-control" cols="30" rows="5"
									readonly></textarea>
							</fieldset>
						</div>
						<div class="form-group col-sm-12">
							...
							<fieldset class="form-group">
								<textarea name="rpjmd_sasaran_indikator_nama" class="form-control" cols="30" rows="5"
									readonly></textarea>
							</fieldset>
						</div>
						<div class="form-group col-sm-9">
							...
							<fieldset class="form-group">
								<input type="text" name="rpjmd_sasaran_indikator_target" class="form-control" readonly>
							</fieldset>
						</div>
						<div class="form-group col-sm-3">
							<label for="basicInput">Satuan</label>
							<fieldset class="form-group">
								<input type="text" name="rpjmd_sasaran_indikator_satuan" class="form-control" readonly>
							</fieldset>
						</div>
						<div class="form-group col-sm-9">
...
$(document).ready(function() {
	...
	var table = $('.my-datatable').DataTable({
		...
		columns: [{
			...
			{
				data: 'rpjmd_sasaran_indikator_th' + tahun_ke + '_target',
			},
			{
				data: 'pagu',
				render: function(e) {
			...
			{
				data: 'rpjmd_sasaran_indikator_th' + tahun_ke + '_realisasi_target',
			},
			{
				data: 'realisasi_pagu',
				render: function(e) {
...
function setUpdate(id) {
	...
	$.when(sendAjax(url, {}, 'get', '#form-data')).done(function(res) {
		if (res.status) {
			...
			$('input[name="realisasi_kinerja"]').val(dataPilih['rpjmd_sasaran_indikator_th' + tahun_ke +
				'_realisasi_target']);
			$('input[name="realisasi_pagu"]').val(dataPilih['rpjmd_sasaran_indikator_th' + tahun_ke + '_realisasi_pagu']);
			...
			$('input[name="rpjmd_sasaran_indikator_target"]').val(res.data['rpjmd_sasaran_indikator_th' + tahun_ke +
				'_target']);
		} else {
