				...
				<form action="" id="form-data">
					...
					<div class="row">
						<div class="form-group col-sm-4">
							...
							<fieldset class="form-group">
								<select name="program" class="form-control select2" required>
									...
									<option
										value="{{ $row->permen_ver.'-'.$row->urusan_kode.'-'.$row->bidang_kode.'-'.$row->program_kode }}">
										{{ $row->program_nama }}</option>
									@endforeach
								</select>
							</fieldset>
						</div>
						...
						<div class="form-group col-sm-6">
							...
							<fieldset class="form-group">
								<input type="number" step="0.01" name="rkpd_sub_kegiatan_indikator_pagu" class="form-control">
							</fieldset>
						</div>
					</div>
				</form>
