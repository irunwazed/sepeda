				...
				<form action="" id="form-data">
					...
					<div class="form-group">
						...
						<fieldset class="form-group">
							<select name="sub_kegiatan" class="form-control select2" required>
								...
								<option
									value="{{ $row->permen_ver.'-'.$row->urusan_kode.'-'.$row->bidang_kode.'-'.$row->program_kode.'-'.$row->kegiatan_kode.'-'.$row->sub_kegiatan_kode }}">
									{{ $row->sub_kegiatan_nama }}</option>
								@endforeach
							</select>
						</fieldset>
					</div>
					...
					<div class="row">
						<div class="form-group col-sm-6">
							...
							<fieldset class="form-group">
								<input type="text" name="renstra_sub_kegiatan_indikator_th0_realisasi_target" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
						...
						<div class="form-group col-sm-6">
							...
							<fieldset class="form-group">
								<input type="text" name="renstra_sub_kegiatan_indikator_th1_target" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
							<label for="basicInput">Pagu {{ session('rpjmd_tahun') }}</label>
							<fieldset class="form-group">
								<input type="number" step="0.01" name="renstra_sub_kegiatan_indikator_th1_pagu" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
							<label for="basicInput">Target {{ session('rpjmd_tahun')+1 }}</label>
							<fieldset class="form-group">
								<input type="text" name="renstra_sub_kegiatan_indikator_th2_target" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
							<label for="basicInput">Pagu {{ session('rpjmd_tahun')+1 }}</label>
							<fieldset class="form-group">
								<input type="number" step="0.01" name="renstra_sub_kegiatan_indikator_th2_pagu" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
							<label for="basicInput">Target {{ session('rpjmd_tahun')+2 }}</label>
							<fieldset class="form-group">
								<input type="text" name="renstra_sub_kegiatan_indikator_th3_target" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
							<label for="basicInput">Pagu {{ session('rpjmd_tahun')+2 }}</label>
							<fieldset class="form-group">
								<input type="number" step="0.01" name="renstra_sub_kegiatan_indikator_th3_pagu" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
							<label for="basicInput">Target {{ session('rpjmd_tahun')+3 }}</label>
							<fieldset class="form-group">
								<input type="text" name="renstra_sub_kegiatan_indikator_th4_target" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
							<label for="basicInput">Pagu {{ session('rpjmd_tahun')+3 }}</label>
							<fieldset class="form-group">
								<input type="number" step="0.01" name="renstra_sub_kegiatan_indikator_th4_pagu" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
							<label for="basicInput">Target {{ session('rpjmd_tahun')+4 }}</label>
							<fieldset class="form-group">
								<input type="text" name="renstra_sub_kegiatan_indikator_th5_target" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
							<label for="basicInput">Pagu {{ session('rpjmd_tahun')+4 }}</label>
							<fieldset class="form-group">
								<input type="number" step="0.01" name="renstra_sub_kegiatan_indikator_th5_pagu" class="form-control">
							</fieldset>
						</div>
					</div>
				</form>
...
$(document).ready(function() {
	...
	var table = $('.my-datatable').DataTable({
		...
		columns: [{
			...
			{
				data: 'renstra_sub_kegiatan_indikator_th0_realisasi_target',
			},
			{
			...
			{
				data: 'renstra_sub_kegiatan_indikator_th1_target',
			},
			{
			...
			{
				data: 'renstra_sub_kegiatan_indikator_th2_target',
			},
			{
			...
			{
				data: 'renstra_sub_kegiatan_indikator_th3_target',
			},
			{
			...
			{
				data: 'renstra_sub_kegiatan_indikator_th4_target',
			},
			{
			...
			{
				data: 'renstra_sub_kegiatan_indikator_th5_target',
			},
			{
