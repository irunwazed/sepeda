				...
				<form action="" id="form-data">
					...
					<div class="row">
						<div class="form-group col-sm-6">
							...
							<fieldset class="form-group">
								<input type="number" step="0.0001" name="renstra_sub_kegiatan_indikator_th0_realisasi_target" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
						...
						<div class="form-group col-sm-6">
							...
							<fieldset class="form-group">
								<input type="number" step="0.0001" name="renstra_sub_kegiatan_indikator_th1_target" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
							<label for="basicInput">Pagu {{ session('rpjmd_tahun') }}</label>
							<fieldset class="form-group">
								<input type="number" step="0.0001" name="renstra_sub_kegiatan_indikator_th1_pagu" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
							<label for="basicInput">Target {{ session('rpjmd_tahun')+1 }}</label>
							<fieldset class="form-group">
								<input type="number" step="0.0001" name="renstra_sub_kegiatan_indikator_th2_target" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
							<label for="basicInput">Pagu {{ session('rpjmd_tahun')+1 }}</label>
							<fieldset class="form-group">
								<input type="number" step="0.0001" name="renstra_sub_kegiatan_indikator_th2_pagu" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
							<label for="basicInput">Target {{ session('rpjmd_tahun')+2 }}</label>
							<fieldset class="form-group">
								<input type="number" step="0.0001" name="renstra_sub_kegiatan_indikator_th3_target" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
							<label for="basicInput">Pagu {{ session('rpjmd_tahun')+2 }}</label>
							<fieldset class="form-group">
								<input type="number" step="0.0001" name="renstra_sub_kegiatan_indikator_th3_pagu" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
							<label for="basicInput">Target {{ session('rpjmd_tahun')+3 }}</label>
							<fieldset class="form-group">
								<input type="number" step="0.0001" name="renstra_sub_kegiatan_indikator_th4_target" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
							<label for="basicInput">Pagu {{ session('rpjmd_tahun')+3 }}</label>
							<fieldset class="form-group">
								<input type="number" step="0.0001" name="renstra_sub_kegiatan_indikator_th4_pagu" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
							<label for="basicInput">Target {{ session('rpjmd_tahun')+4 }}</label>
							<fieldset class="form-group">
								<input type="number" step="0.0001" name="renstra_sub_kegiatan_indikator_th5_target" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
							<label for="basicInput">Pagu {{ session('rpjmd_tahun')+4 }}</label>
							<fieldset class="form-group">
								<input type="number" step="0.0001" name="renstra_sub_kegiatan_indikator_th5_pagu" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
							<label for="basicInput">Target Tahun Akhir</label>
							<fieldset class="form-group">
								<input type="number" step="0.0001" name="renstra_sub_kegiatan_indikator_th6_target" class="form-control">
							</fieldset>
						</div>
					</div>
				</form>
