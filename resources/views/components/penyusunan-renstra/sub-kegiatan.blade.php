				...
				<form action="" id="form-data">
					...
					<div class="row">
						<div class="form-group col-sm-6">
							...
							<fieldset class="form-group">
								<input type="number" step="0.01" name="renstra_sub_kegiatan_indikator_th0_realisasi_target" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
						...
						<div class="form-group col-sm-6">
							...
							<fieldset class="form-group">
								<input type="number" step="0.01" name="renstra_sub_kegiatan_indikator_th1_target" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
						...
						<div class="form-group col-sm-6">
							...
							<fieldset class="form-group">
								<input type="number" step="0.01" name="renstra_sub_kegiatan_indikator_th2_target" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
						...
						<div class="form-group col-sm-6">
							...
							<fieldset class="form-group">
								<input type="number" step="0.01" name="renstra_sub_kegiatan_indikator_th3_target" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
						...
						<div class="form-group col-sm-6">
							...
							<fieldset class="form-group">
								<input type="number" step="0.01" name="renstra_sub_kegiatan_indikator_th4_target" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
						...
						<div class="form-group col-sm-6">
							...
							<fieldset class="form-group">
								<input type="number" step="0.01" name="renstra_sub_kegiatan_indikator_th5_target" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-6">
