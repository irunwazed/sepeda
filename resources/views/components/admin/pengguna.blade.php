				...
				<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable "
						...
						<div class="modal-content">
								...
								<div class="modal-footer">
										...
										<button id="btn-form-data" type="submit" form="form-data"  class="btn btn-success ml-1"
												>Tambah
										</button>
								</div>
						</div>
    ...
    $(document).ready(function() {
			var table = $('.my-datatable').DataTable({
				...
				columns: [
					...
					{ data: 'login_nama', name: 'login_nama' },
					{ data: 'login_username', name: 'login_username' },
					{ data: 'login_level', name: 'login_level' },
    ...
    function setUpdate(id){
			...
			$.when(sendAjax(url, {}, 'get', '#form-data')).done(function(res){
				if(res.status){
					...
					console.log(res);
					$('select[name="login_level"]').val(res.data.login_level).trigger('change');
					$('input[name="login_nama"]').val(res.data.login_nama);
					$('input[name="login_username"]').val(res.data.login_username);
				}else{
