			...
			<div class="modal-body">
				<form action="" id="form-data">
					...
					<div class="form-group">
						...
						<fieldset class="form-group">
							<textarea name="rpjmd_tujuan_indikator_nama" class="form-control" cols="30" rows="5"></textarea>
						</fieldset>
					</div>
					<div class="form-group">
						<label for="basicInput">Satuan</label>
						<fieldset class="form-group">
							<input type="text" name="rpjmd_tujuan_indikator_satuan" class="form-control">
						</fieldset>
					</div>
					<div class="row">
						<div class="form-group col-sm-4">
							...
							<fieldset class="form-group">
								<select name="rpjmd_tujuan_indikator_nilai_jenis" class="form-control">
					...
					<div class="row">
						<div class="form-group col-sm-4">
							<label for="basicInput">Target Tahun Awal</label>
							<fieldset class="form-group">
								<input type="number" step="0.01" name="rpjmd_tujuan_indikator_th0_realisasi_target" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-4">
							<label for="basicInput">Target {{ session('rpjmd_tahun') }}</label>
							<fieldset class="form-group">
								<input type="number" step="0.01" name="rpjmd_tujuan_indikator_th1_target" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-4">
							<label for="basicInput">Target {{ session('rpjmd_tahun')+1 }}</label>
							<fieldset class="form-group">
								<input type="number" step="0.01" name="rpjmd_tujuan_indikator_th2_target" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-4">
							<label for="basicInput">Target {{ session('rpjmd_tahun')+2 }}</label>
							<fieldset class="form-group">
								<input type="number" step="0.01" name="rpjmd_tujuan_indikator_th3_target" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-4">
							<label for="basicInput">Target {{ session('rpjmd_tahun')+3 }}</label>
							<fieldset class="form-group">
								<input type="number" step="0.01" name="rpjmd_tujuan_indikator_th4_target" class="form-control">
							</fieldset>
						</div>
						<div class="form-group col-sm-4">
							<label for="basicInput">Target {{ session('rpjmd_tahun')+4 }}</label>
							<fieldset class="form-group">
								<input type="number" step="0.01" name="rpjmd_tujuan_indikator_th5_target" class="form-control">
							</fieldset>
						</div>
					</div>
				</form>
...
var dataPilih = {};
var kode = '{{ @$kode }}';
var rpjmd_tujuan_nama = '{{ @$dataAwal->rpjmd_tujuan_nama }}';
$(document).ready(function() {
	...
	var table = $('.my-datatable').DataTable({
		...
		columns: [{
			...
			{
				data: 'rpjmd_tujuan_indikator_th0_realisasi_target',
			},
			{
				data: 'rpjmd_tujuan_indikator_th1_target',
			},
			{
				data: 'rpjmd_tujuan_indikator_th2_target',
			},
			{
				data: 'rpjmd_tujuan_indikator_th3_target',
			},
			{
				data: 'rpjmd_tujuan_indikator_th4_target',
			},
			{
				data: 'rpjmd_tujuan_indikator_th5_target',
			},
			{
				data: 'action',
			},
...
function setCreate() {
	...
	$('textarea[name="rpjmd_tujuan_nama"]').html(rpjmd_tujuan_nama);
}
...
function setUpdate(id) {
	...
	$.when(sendAjax(url, {}, 'get', '#form-data')).done(function(res) {
		if (res.status) {
			...
			$('input[name="rpjmd_tujuan_indikator_th0_realisasi_target"]').val(res.data
				.rpjmd_tujuan_indikator_th0_realisasi_target);
			$('input[name="rpjmd_tujuan_indikator_th1_target"]').val(res.data.rpjmd_tujuan_indikator_th1_target);
			$('input[name="rpjmd_tujuan_indikator_th2_target"]').val(res.data.rpjmd_tujuan_indikator_th2_target);
			$('input[name="rpjmd_tujuan_indikator_th3_target"]').val(res.data.rpjmd_tujuan_indikator_th3_target);
			$('input[name="rpjmd_tujuan_indikator_th4_target"]').val(res.data.rpjmd_tujuan_indikator_th4_target);
			$('input[name="rpjmd_tujuan_indikator_th5_target"]').val(res.data.rpjmd_tujuan_indikator_th5_target);
		} else {
...
$('select[name="rpjmd_tujuan_indikator_nilai_jenis"]').change(function() {
	let val = $(this).val();
	console.log(val);
	if (val == 2) {
		addIndikatorNilai();
...
function addIndikatorNilai() {
	isi = '	<div class="row" id="nilai-' + indikatorNilai + '">\
						<div class="form-group col-sm-5" >\
							...
							<fieldset class="form-group">\
								<input type="text" name="indikator_nilai[]" class="form-control">\
							</fieldset>\
						</div>\
