				...
				<form action="" id="form-data">
					...
					<div class="form-group">
						...
						<fieldset class="form-group">
							<textarea name="program_nama" class="form-control" cols="30" rows="5" readonly></textarea>
						</fieldset>
					</div>
					<div class="form-group">
...
var dataPilih = {};
var kode = '{{ @$kode }}';
var program_nama = '{{ @$dataAwal->program_nama }}';
$(document).ready(function() {
	...
	var table = $('.my-datatable').DataTable({
		...
		columns: [{
			...
			{
				data: 'rpjmd_program_indikator_nama',
			},
			{
...
function setUpdate(id) {
	...
	$.when(sendAjax(url, {}, 'get', '#form-data')).done(function(res) {
		if (res.status) {
			...
			$('input[name="kode"]').val(kode);
			$('textarea[name="program_nama"]').html(res.data.program_nama);
			$('textarea[name="rpjmd_program_indikator_nama"]').html(res.data.rpjmd_program_indikator_nama);
			$('input[name="rpjmd_program_indikator_satuan"]').val(res.data.rpjmd_program_indikator_satuan);
			$('input[name="rpjmd_program_indikator_th0_realisasi_target"]').val(res.data.rpjmd_program_indikator_th0_realisasi_target);
			$('input[name="rpjmd_program_indikator_th1_target"]').val(res.data.rpjmd_program_indikator_th1_target);
			$('input[name="rpjmd_program_indikator_th2_target"]').val(res.data.rpjmd_program_indikator_th2_target);
			$('input[name="rpjmd_program_indikator_th3_target"]').val(res.data.rpjmd_program_indikator_th3_target);
			$('input[name="rpjmd_program_indikator_th4_target"]').val(res.data.rpjmd_program_indikator_th4_target);
			$('input[name="rpjmd_program_indikator_th5_target"]').val(res.data.rpjmd_program_indikator_th5_target);
			$('input[name="rpjmd_program_indikator_th6_target"]').val(res.data.rpjmd_program_indikator_th6_target);
		} else {
