...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?=$awalAssets?>/awal/fonts/icomoon/style.css">

    <link rel="stylesheet" href="<?=$awalAssets?>/awal/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?=$awalAssets?>/awal/css/jquery.fancybox.min.css">
    <link rel="stylesheet" href="<?=$awalAssets?>/awal/css/owl.carousel.min.css">
    <link rel="stylesheet" href="<?=$awalAssets?>/awal/css/owl.theme.default.min.css">
    <link rel="stylesheet" href="<?=$awalAssets?>/awal/fonts/flaticon/font/flaticon.css">
    <link rel="stylesheet" href="<?=$awalAssets?>/awal/css/aos.css">

    <!-- MAIN CSS -->
    <link rel="stylesheet" href="<?=$awalAssets?>/awal/css/style.css">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="site-wrap" id="home-section">
      ...
      <div class="ftco-blocks-cover-1">
        <div class="ftco-cover-1 overlay" style="background-image: url('<?=$awalAssets?>/awal/images/depot_hero_1.jpg')">
          <div class="container">
          ...
          <div class="container">
            <div class="owl-carousel owl-all">
              <div class="service text-center">
                <a href="#"><img src="<?=$awalAssets?>/awal/images/depot_img_1.jpg" alt="Image" class="img-fluid"></a>
                <div class="px-md-3">
              ...
              <div class="service text-center">
                <a href="#"><img src="<?=$awalAssets?>/awal/images/depot_img_2.jpg" alt="Image" class="img-fluid"></a>
                <div class="px-md-3">
              ...
              <div class="service text-center">
                <a href="#"><img src="<?=$awalAssets?>/awal/images/depot_img_3.jpg" alt="Image" class="img-fluid"></a>
                <div class="px-md-3">
          ...
          <div class="row justify-content-center mb-4 block-img-video-1-wrap">
            <div class="col-md-12 mb-5">
              <figure class="block-img-video-1" data-aos="fade">
                ...
                <img src="<?=$awalAssets?>/awal/images/depot_delivery_1.jpg" alt="Image" class="img-fluid">
              </a>
              </figure>
            </div>
          </div>
        ...
        <div class="container">
          ...
          <div class="owl-carousel owl-all mb-5">
            <div class="block-team-member-1 text-center rounded h-100">
              <figure>
                <img src="<?=$awalAssets?>/awal/images/person_1.jpg" alt="Image" class="img-fluid rounded-circle">
              </figure>
            ...
            <div class="block-team-member-1 text-center rounded h-100">
              <figure>
                <img src="<?=$awalAssets?>/awal/images/person_2.jpg" alt="Image" class="img-fluid rounded-circle">
              </figure>
            ...
            <div class="block-team-member-1 text-center rounded h-100">
              <figure>
                <img src="<?=$awalAssets?>/awal/images/person_3.jpg" alt="Image" class="img-fluid rounded-circle">
              </figure>
          ...
          <div class="owl-carousel nonloop-block-13">
            <div>
              <div class="block-testimony-1 text-center">
                ...
                <figure>
                  <img src="<?=$awalAssets?>/awal/images/person_1.jpg" alt="Image" class="img-fluid rounded-circle mx-auto">
                </figure>
            ...
            <div>
              <div class="block-testimony-1 text-center">
                ...
                <figure>
                  <img src="<?=$awalAssets?>/awal/images/person_2.jpg" alt="Image" class="img-fluid rounded-circle mx-auto">
                </figure>
            ...
            <div>
              <div class="block-testimony-1 text-center">
                ...
                <figure>
                  <img src="<?=$awalAssets?>/awal/images/person_3.jpg" alt="Image" class="img-fluid rounded-circle mx-auto">
                </figure>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="mb-5 d-block blog-entry" data-aos="fade-right" data-aos-delay="">
                <a href="single.html" class="blog-thumbnail mb-3 d-block"><img src="<?=$awalAssets?>/awal/images/depot_img_1.jpg" alt="Image" class="img-fluid"></a>
            ...
            <div class="col-lg-6">
              <div class="mb-5 d-block blog-entry" data-aos="fade-right" data-aos-delay="">
                <a href="single.html" class="blog-thumbnail mb-3 d-block"><img src="<?=$awalAssets?>/awal/images/depot_img_2.jpg" alt="Image" class="img-fluid"></a>
                <div class="blog-excerpt">
                  <span class="d-block text-muted">Apr 19, 2019</span>
                  <h2 class="h4  mb-3"><a href="single.html">Knowing the Difference Is Key to Effective Logistics</a></h2>
    ...
    <script src="<?=$awalAssets?>/awal/js/jquery-3.3.1.min.js"></script>
    <script src="<?=$awalAssets?>/awal/js/popper.min.js"></script>
    <script src="<?=$awalAssets?>/awal/js/bootstrap.min.js"></script>
    <script src="<?=$awalAssets?>/awal/js/owl.carousel.min.js"></script>
    <script src="<?=$awalAssets?>/awal/js/jquery.sticky.js"></script>
    <script src="<?=$awalAssets?>/awal/js/jquery.waypoints.min.js"></script>
    <script src="<?=$awalAssets?>/awal/js/jquery.animateNumber.min.js"></script>
    <script src="<?=$awalAssets?>/awal/js/jquery.fancybox.min.js"></script>
    <script src="<?=$awalAssets?>/awal/js/jquery.easing.1.3.js"></script>
    <script src="<?=$awalAssets?>/awal/js/aos.js"></script>

    <script src="<?=$awalAssets?>/awal/js/main.js"></script>
