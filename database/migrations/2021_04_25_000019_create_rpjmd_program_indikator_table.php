...
class CreateRpjmdProgramIndikatorTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('ta_rpjmd_program_indikator', function (Blueprint $table) {
					...
					$table->double('rpjmd_program_indikator_th0_realisasi_target')->nullable(); 
					$table->double('rpjmd_program_indikator_th0_realisasi_pagu')->nullable(); 
					$table->double('rpjmd_program_indikator_th1_target')->nullable(); 
					$table->double('rpjmd_program_indikator_th1_pagu')->nullable(); 
					$table->double('rpjmd_program_indikator_th1_realisasi_target')->nullable(); 
					$table->double('rpjmd_program_indikator_th1_realisasi_pagu')->nullable(); 
					$table->double('rpjmd_program_indikator_th1_capaian_target')->nullable(); 
					$table->double('rpjmd_program_indikator_th1_capaian_pagu')->nullable(); 
					$table->double('rpjmd_program_indikator_th2_target')->nullable(); 
					$table->double('rpjmd_program_indikator_th2_pagu')->nullable(); 
					$table->double('rpjmd_program_indikator_th2_realisasi_target')->nullable(); 
					$table->double('rpjmd_program_indikator_th2_realisasi_pagu')->nullable(); 
					$table->double('rpjmd_program_indikator_th2_capaian_target')->nullable(); 
					$table->double('rpjmd_program_indikator_th2_capaian_pagu')->nullable(); 
					$table->double('rpjmd_program_indikator_th3_target')->nullable(); 
					$table->double('rpjmd_program_indikator_th3_pagu')->nullable(); 
					$table->double('rpjmd_program_indikator_th3_realisasi_target')->nullable(); 
					$table->double('rpjmd_program_indikator_th3_realisasi_pagu')->nullable(); 
					$table->double('rpjmd_program_indikator_th3_capaian_target')->nullable(); 
					$table->double('rpjmd_program_indikator_th3_capaian_pagu')->nullable(); 
					$table->double('rpjmd_program_indikator_th4_target')->nullable(); 
					$table->double('rpjmd_program_indikator_th4_pagu')->nullable(); 
					$table->double('rpjmd_program_indikator_th4_realisasi_target')->nullable(); 
					$table->double('rpjmd_program_indikator_th4_realisasi_pagu')->nullable(); 
					$table->double('rpjmd_program_indikator_th4_capaian_target')->nullable(); 
					$table->double('rpjmd_program_indikator_th4_capaian_pagu')->nullable(); 
					$table->double('rpjmd_program_indikator_th5_target')->nullable(); 
					$table->double('rpjmd_program_indikator_th5_pagu')->nullable(); 
					$table->double('rpjmd_program_indikator_th5_realisasi_target')->nullable(); 
					$table->double('rpjmd_program_indikator_th5_realisasi_pagu')->nullable(); 
					$table->double('rpjmd_program_indikator_th5_capaian_target')->nullable(); 
					$table->double('rpjmd_program_indikator_th5_capaian_pagu')->nullable(); 
					$table->double('rpjmd_program_indikator_th6_target')->nullable(); 
					$table->double('rpjmd_program_indikator_th6_pagu')->nullable(); 
					$table->double('rpjmd_program_indikator_th6_realisasi_target')->nullable(); 
					$table->double('rpjmd_program_indikator_th6_realisasi_pagu')->nullable(); 
					$table->double('rpjmd_program_indikator_th6_capaian_target')->nullable(); 
					$table->double('rpjmd_program_indikator_th6_capaian_pagu')->nullable(); 
					$table->timestamps();
