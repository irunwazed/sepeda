...
class CreateRenstraSasaranIndikatorTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('ref_renstra_sasaran_indikator', function (Blueprint $table) {
					...
					$table->string('renstra_sasaran_indikator_th1_capaian_target')->nullable(); 
					...
					$table->string('renstra_sasaran_indikator_th2_capaian_target')->nullable(); 
					...
					$table->string('renstra_sasaran_indikator_th3_capaian_target')->nullable(); 
					...
					$table->string('renstra_sasaran_indikator_th4_capaian_target')->nullable(); 
					...
					$table->string('renstra_sasaran_indikator_th5_capaian_target')->nullable(); 
