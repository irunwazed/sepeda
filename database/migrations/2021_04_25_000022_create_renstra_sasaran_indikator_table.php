...
class CreateRenstraSasaranIndikatorTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('ref_renstra_sasaran_indikator', function (Blueprint $table) {
					...
					$table->double('renstra_sasaran_indikator_th6_target')->nullable(); 
					$table->double('renstra_sasaran_indikator_th6_pagu')->nullable(); 
					$table->double('renstra_sasaran_indikator_th6_realisasi_target')->nullable(); 
					$table->double('renstra_sasaran_indikator_th6_realisasi_pagu')->nullable();
					$table->double('renstra_sasaran_indikator_th6_capaian_target')->nullable(); 
					$table->double('renstra_sasaran_indikator_th6_capaian_pagu')->nullable();
					$table->timestamps();
